...
A name heading plus the greeting `Hi, I'm Abdullah` says the name twice. The Profile uses the typing SVG as the only hero: no name H1. Greeting copy, JetBrains Mono at weight 600 and size 22, 2400ms per line, 600ms pause.
